//PostProcessFinalHDRGameplaySimpleFrameGen.hlsl
//Game Shader Version: 1.0.0.5

//Frame generation variant of HDRGameplaySimple: normal gameplay: one UI layer, single LUT, no composition context.
//
