//PostProcessFinalHDRBackdropFrameGen.hlsl
//Game Shader Version: 1.0.0.5

//Frame generation variant of PostProcessFinalHDRBackdrop: gameplay with a composition backdrop active: one UI layer.
//
