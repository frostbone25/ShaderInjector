//PostProcessFinalHDR3LayerBackdropRemapFrameGen.hlsl
//Game Shader Version: 1.0.0.5

//Frame generation variant of PostProcessFinalHDR3LayerBackdropRemap: three UI composite layers with a composition backdrop active, at non-neutral HDR calibration.
//
