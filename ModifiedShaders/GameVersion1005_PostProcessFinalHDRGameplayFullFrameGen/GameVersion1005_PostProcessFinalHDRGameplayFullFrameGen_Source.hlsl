//PostProcessFinalHDRGameplayFullFrameGen.hlsl
//Game Shader Version: 1.0.0.5

//Frame generation variant of HDRGameplayFull: gameplay at non-neutral HDR calibration with a composition backdrop active: one UI layer.
//
