//PostProcessFinalHDRMenuFull.hlsl
//Game Shader Version: 1.0.0.5

//HDR menu pass with non-neutral calibration and a composition backdrop active. Three UI layers, all three LUTs.
//Original game shader: PixelShader AD971BD64DEB7F9E
//[NO CONFIG]
#define POSTPROCESS_FINAL_HDR_MENU_FULL
